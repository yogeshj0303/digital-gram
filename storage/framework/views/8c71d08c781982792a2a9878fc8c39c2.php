...
<h4 class="fs-16 mb-1">Good Morning, <?php echo e(Auth::user()->name); ?>, </h4><p class ="text-muted mb-0" id="current-time" class="fs-14"></p>
    ...
    <h4 class="fs-22 fw-semibold ff-secondary mb-4">
        <span id="categoryCount" class="text-primary">0</span>
                                    ...
                                    <a href="<?php echo e(route('register-to-gram.index')); ?>" class="text-decoration-none text-muted">View Users</a>
                                </div>
   ...
   <div class="d-flex align-items-center flex-wrap">
    ...
    <select id="gramDropdown" class="form-select  mb-3">
        ...
        <?php $__currentLoopData = $grams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gram): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($gram->gram_name); ?>"><?php echo e($gram->gram_name); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
...
<script>
    document.getElementById('categoryDropdown').addEventListener('change', function() {
        ...
        fetch('<?php echo e(route("get.category.count")); ?>', {
            method: 'POST',
            headers: {
...
<script>
    $(document).ready(function() {
        ...
        $('#showGharPattiUsers').click(function() {
            $.ajax({
                url: '<?php echo e(route("get.ghar-patti-users")); ?>',
                type: 'GET',
                success: function(response) {
                    var userList = '';
        ...
        $('#showPanipattiUsers').click(function() {
            $.ajax({
                url: '<?php echo e(route("get.panipatti-users")); ?>',
                type: 'GET',
                success: function(response) {
                    var userList = '';
                    $.each(response, function(index, user) {
