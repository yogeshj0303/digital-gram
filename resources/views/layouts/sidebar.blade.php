    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('grams.index') }}" class="nav-link">Manage Gram</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('register-to-gram.index') }}" class="nav-link">Add Register To Gram</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="">
                    <a class="nav-link " href="{{ route('gharpatti-panipatti.index') }}" >
                ...
                <li class="">
                    <a class="nav-link menu-link" href="{{ route('about-gram.index') }}" >
                ...
                <li class="">
                    <a class="nav-link menu-link" href="{{ route('population.index') }}">
