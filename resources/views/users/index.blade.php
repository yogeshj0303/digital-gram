            ...
            <div class="card-body">
                <div class="listjs-table" id="customerList">
                    ...
                    <div class="table-responsive   mt-3 mb-1">
                        <table class="table align-middle table-bordered table-nowrap">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr id="talukaRow{{ $user->id }}" data-id="{{ $user->id }}">
                                    ...
                                    <td class="phone">{{ $user->user_type }}</td>
                                    <td class="date">{{ $user->gharpatti_annual }}</td>
                                    <td class="customer_name">{{ $user->panipatti_annual }}</td>
                                    <td class="email">{{ $user->home_type }}</td>
